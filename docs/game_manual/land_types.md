...
There are 18 capturable land types in the game. Each has unique mana production, defenders, and special buildings.

## Universal Buildings

> "On all lands you can build: fortifications (3 levels), fletchery, and archery guild. On all lands you can replace land defenders with four strength levels of mobs."
> — Help file, line 79
...
## Additional Land Types (from data files)
...
**Defenders:** Electric Ant → Ancient Scarab → Mummy → Apparition

**Special Buildings:** Sarcophagus, Stone of Wisdom
...
**Defenders:** Thief → Marauder → Robber Chief → Politician

**Special Buildings:** Treasury, Precision Stone, Precision Crystal
...
**Defenders:** Hardshell Crab → Crocodile → Pirate → Kraken

**Special Buildings:** Water Altar, Magic Room, Magic Hallway
